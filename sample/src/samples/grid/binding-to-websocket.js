...
//       alert('This demo requires WebSocket');
//       return;
//     }
//
//     let host = 'wss://kendo.jeroenvinke.nl';
...
//           let request = { type: 'update', data: [options.data] };
//
//           send(ws, request, options.success);
//         },
//         destroy: function(options) {
//           let request = { type: 'destroy', data: [options.data] };
//
//           send(ws, request, options.success);
//         },
//         create: function(options) {
//           let request = { type: 'create', data: [options.data] };
//
//           send(ws, request, options.success);
//         }
//       }
