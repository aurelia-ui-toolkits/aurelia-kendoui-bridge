define(['exports', './common/decorators', 'aurelia-logging', 'aurelia-templating-resources', 'aurelia-dependency-injection', 'aurelia-templating', 'aurelia-metadata', 'aurelia-binding', 'aurelia-task-queue', 'jquery', 'kendo.data.min', 'kendo.autocomplete.min', 'kendo.virtuallist.min', 'kendo.dataviz.barcode.min', 'kendo.button.min', 'kendo.mobile.buttongroup.min', 'kendo.calendar.min', 'kendo.dataviz.chart.min', 'kendo.dataviz.chart.polar.min', 'kendo.dataviz.chart.funnel.min', 'kendo.dataviz.sparkline.min', 'kendo.dataviz.stock.min', 'kendo.dataviz.treemap.min', 'kendo.colorpicker.min', 'kendo.combobox.min', 'kendo.menu.min', 'kendo.datepicker.min', 'kendo.datetimepicker.min', 'kendo.dataviz.diagram.min', 'kendo.draganddrop.min', 'kendo.dropdownlist.min', 'kendo.editor.min', 'kendo.gantt.min', 'kendo.dataviz.gauge.min', 'kendo.data.signalr.min', 'kendo.filtercell.min', 'kendo.grid.min', 'kendo.listview.min', 'kendo.dataviz.map.min', 'kendo.maskedtextbox.min', 'kendo.multiselect.min', 'kendo.notification.min', 'kendo.numerictextbox.min', 'kendo.panelbar.min', 'kendo.pdf.min', 'kendo.excel.min', 'kendo.pivot.configurator.min', 'kendo.pivotgrid.min', 'kendo.pivot.fieldmenu.min', 'kendo.progressbar.min', 'kendo.dataviz.qrcode.min', 'kendo.slider.min', 'kendo.responsivepanel.min', 'kendo.scheduler.min', 'kendo.scheduler.agendaview.min', 'kendo.scheduler.dayview.min', 'kendo.scheduler.monthview.min', 'kendo.scheduler.recurrence.min', 'kendo.scheduler.timelineview.min', 'kendo.mobile.scrollview.min', 'kendo.sortable.min', 'kendo.splitter.min', 'kendo.spreadsheet.min', 'kendo.mobile.switch.min', 'kendo.tabstrip.min', 'kendo.timepicker.min', 'kendo.toolbar.min', 'kendo.tooltip.min', 'kendo.treelist.min', 'kendo.treeview.min', 'kendo.upload.min', 'kendo.validator.min', 'kendo.window.min'], function (exports, _decorators, _aureliaLogging, _aureliaTemplatingResources, _aureliaDependencyInjection, _aureliaTemplating, _aureliaMetadata, _aureliaBinding, _aureliaTaskQueue) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Window = exports.kendoFormatValueConverter = exports.kendoStringifyValueConverter = exports.kendoParseColorValueConverter = exports.kendoParseFloatValueConverter = exports.kendoParseIntValueConverter = exports.kendoParseDateValueConverter = exports.kendoToStringValueConverter = exports.Validator = exports.Upload = exports.TreeView = exports.TreeList = exports.TreeCol = exports.Tooltip = exports.Toolbar = exports.ToolbarItem = exports.ToolbarItemButton = exports.TimePicker = exports.TabStrip = exports.Switch = exports.Spreadsheet = exports.Splitter = exports.Sortable = exports.Slider = exports.Scrollview = exports.Scheduler = exports.ResponsivePanel = exports.RangeSlider = exports.QRCode = exports.ProgressBar = exports.PivotGrid = exports.PivotConfigurator = exports.PDF = exports.PanelBar = exports.NumericTextBox = exports.Notification = exports.NotificationTemplate = exports.Multiselect = exports.Menu = exports.MaskedTextBox = exports.Map = exports.ListView = exports.Grid = exports.GridToolbar = exports.Col = exports.RadialGauge = exports.LinearGauge = exports.Gantt = exports.GanttCol = exports.FlatColorPicker = exports.Editor = exports.DropDownList = exports.DropTarget = exports.DropTargetArea = exports.Draggabke = exports.Diagram = exports.DateTimePicker = exports.DatePicker = exports.ContextMenu = exports.WidgetBase = exports.Util = exports.Template = exports.TemplateGatherer = exports.TemplateCompiler = exports.OptionsBuilder = exports.NotifyBindingBehavior = exports.ControlProperties = exports.constants = exports.bindables = exports.ComboBox = exports.ColorPicker = exports.ColorPalette = exports.TreeMap = exports.Stock = exports.Sparkline = exports.Chart = exports.Calendar = exports.ButtonGroup = exports.Button = exports.Barcode = exports.AutoComplete = exports.KendoConfigBuilder = undefined;
  ...
  var AutoComplete = exports.AutoComplete = (_dec = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'autocomplete'), _dec2 = generateBindables('kendoAutoComplete'), _dec3 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec4 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec(_class2 = _dec2(_class2 = _dec3(_class2 = (_class3 = function () {
  ...
  var Barcode = exports.Barcode = (_dec5 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'barcode'), _dec6 = generateBindables('kendoBarcode'), _dec7 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec5(_class5 = _dec6(_class5 = _dec7(_class5 = function () {
  ...
  var Button = exports.Button = (_dec8 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'button'), _dec9 = generateBindables('kendoButton'), _dec10 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec8(_class6 = _dec9(_class6 = _dec10(_class6 = (_class7 = function () {
    ...
    return Button;
  }(), (_descriptor2 = _applyDecoratedDescriptor(_class7.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class7)) || _class6) || _class6) || _class6);
  var ButtonGroup = exports.ButtonGroup = (_dec11 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'buttongroup'), _dec12 = generateBindables('kendoMobileButtonGroup'), _dec13 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec11(_class9 = _dec12(_class9 = _dec13(_class9 = (_class10 = function () {
    ...
    return ButtonGroup;
  }(), (_descriptor3 = _applyDecoratedDescriptor(_class10.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class10)) || _class9) || _class9) || _class9);
  var Calendar = exports.Calendar = (_dec14 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'calendar'), _dec15 = generateBindables('kendoCalendar'), _dec16 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec14(_class12 = _dec15(_class12 = _dec16(_class12 = function () {
  ...
  var Chart = exports.Chart = (_dec17 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'chart'), _dec18 = generateBindables('kendoChart'), _dec19 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec17(_class13 = _dec18(_class13 = _dec19(_class13 = function () {
  ...
  var Sparkline = exports.Sparkline = (_dec20 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'sparkline'), _dec21 = generateBindables('kendoSparkline'), _dec22 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec20(_class14 = _dec21(_class14 = _dec22(_class14 = function () {
  ...
  var Stock = exports.Stock = (_dec23 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'stock'), _dec24 = generateBindables('kendoStockChart'), _dec25 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec23(_class15 = _dec24(_class15 = _dec25(_class15 = function () {
  ...
  var TreeMap = exports.TreeMap = (_dec26 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'treemap'), _dec27 = generateBindables('kendoTreeMap'), _dec28 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec26(_class16 = _dec27(_class16 = _dec28(_class16 = function () {
  ...
  var ColorPalette = exports.ColorPalette = (_dec29 = (0, _aureliaTemplating.customElement)(constants.attributePrefix + 'color-palette'), _dec30 = generateBindables('kendoColorPalette'), _dec31 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec29(_class17 = _dec30(_class17 = _dec31(_class17 = function () {
  ...
  var ColorPicker = exports.ColorPicker = (_dec32 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'color-picker'), _dec33 = generateBindables('kendoColorPicker'), _dec34 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec32(_class18 = _dec33(_class18 = _dec34(_class18 = (_class19 = function () {
    ...
    return ColorPicker;
  }(), (_descriptor4 = _applyDecoratedDescriptor(_class19.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class19)) || _class18) || _class18) || _class18);
  var ComboBox = exports.ComboBox = (_dec35 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'combobox'), _dec36 = generateBindables('kendoComboBox'), _dec37 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec38 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec35(_class21 = _dec36(_class21 = _dec37(_class21 = (_class22 = function () {
    ...
    return ComboBox;
  }(), (_descriptor5 = _applyDecoratedDescriptor(_class22.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor6 = _applyDecoratedDescriptor(_class22.prototype, 'kReadOnly', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  ...
  var ControlProperties = exports.ControlProperties = (_dec39 = (0, _aureliaDependencyInjection.inject)(Util), _dec39(_class24 = function () {
  ...
  var NotifyBindingBehavior = exports.NotifyBindingBehavior = (_dec40 = (0, _aureliaDependencyInjection.inject)(_aureliaBinding.EventManager), _dec40(_class26 = function () {
  ...
  var OptionsBuilder = exports.OptionsBuilder = (_dec41 = (0, _aureliaDependencyInjection.inject)(ControlProperties, Util), _dec41(_class27 = function () {
  ...
  var TemplateCompiler = exports.TemplateCompiler = (_dec42 = (0, _aureliaDependencyInjection.inject)(_aureliaTemplating.TemplatingEngine, Util), _dec42(_class28 = function () {
  ...
  var TemplateGatherer = exports.TemplateGatherer = (_dec43 = (0, _aureliaDependencyInjection.inject)(ControlProperties, Util, KendoConfigBuilder), _dec43(_class30 = function () {
  ...
  var Template = exports.Template = (_dec44 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'template'), _dec45 = (0, _aureliaTemplating.noView)(), _dec46 = (0, _aureliaTemplating.processContent)(function (compiler, resources, element, instruction) {
    var html = element.innerHTML;
    if (html !== '') {
      instruction.template = html;
    }
    element.innerHTML = '';
  }), _dec47 = (0, _aureliaDependencyInjection.inject)(_aureliaTemplating.TargetInstruction), _dec44(_class32 = _dec45(_class32 = _dec46(_class32 = _dec47(_class32 = (_class33 = function Template(targetInstruction) {
  ...
  }, (_descriptor8 = _applyDecoratedDescriptor(_class33.prototype, 'template', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor9 = _applyDecoratedDescriptor(_class33.prototype, 'for', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: function initializer() {
      return 'template';
    }
  }), _descriptor10 = _applyDecoratedDescriptor(_class33.prototype, 'kendoTemplate', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: function initializer() {
      return false;
    }
  ...
  var WidgetBase = exports.WidgetBase = (_dec48 = (0, _aureliaDependencyInjection.transient)(), _dec49 = (0, _aureliaDependencyInjection.inject)(_aureliaTaskQueue.TaskQueue, TemplateCompiler, OptionsBuilder, Util, TemplateGatherer, KendoConfigBuilder), _dec48(_class35 = _dec49(_class35 = function () {
  ...
  var ContextMenu = exports.ContextMenu = (_dec50 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'contextmenu'), _dec51 = generateBindables('kendoContextMenu'), _dec52 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec50(_class37 = _dec51(_class37 = _dec52(_class37 = function () {
  ...
  var DatePicker = exports.DatePicker = (_dec53 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'datepicker'), _dec54 = generateBindables('kendoDatePicker'), _dec55 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec53(_class38 = _dec54(_class38 = _dec55(_class38 = (_class39 = function () {
    ...
    return DatePicker;
  }(), (_descriptor11 = _applyDecoratedDescriptor(_class39.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor12 = _applyDecoratedDescriptor(_class39.prototype, 'kReadOnly', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class39)) || _class38) || _class38) || _class38);
  var DateTimePicker = exports.DateTimePicker = (_dec56 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'datetimepicker'), _dec57 = generateBindables('kendoDateTimePicker'), _dec58 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec56(_class41 = _dec57(_class41 = _dec58(_class41 = (_class42 = function () {
  ...
  }(), (_descriptor13 = _applyDecoratedDescriptor(_class42.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor14 = _applyDecoratedDescriptor(_class42.prototype, 'kReadOnly', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class42)) || _class41) || _class41) || _class41);
  var Diagram = exports.Diagram = (_dec59 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'diagram'), _dec60 = generateBindables('kendoDiagram'), _dec61 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec59(_class44 = _dec60(_class44 = _dec61(_class44 = function () {
  ...
  var Draggabke = exports.Draggabke = (_dec62 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'draggable'), _dec63 = generateBindables('kendoDraggable'), _dec64 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec62(_class45 = _dec63(_class45 = _dec64(_class45 = function () {
  ...
  var DropTargetArea = exports.DropTargetArea = (_dec65 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'drop-target-area'), _dec66 = generateBindables('kendoDropTargetArea'), _dec67 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec65(_class46 = _dec66(_class46 = _dec67(_class46 = function () {
  ...
  var DropTarget = exports.DropTarget = (_dec68 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'drop-target'), _dec69 = generateBindables('kendoDropTarget'), _dec70 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec68(_class47 = _dec69(_class47 = _dec70(_class47 = function () {
  ...
  var DropDownList = exports.DropDownList = (_dec71 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'drop-down-list'), _dec72 = generateBindables('kendoDropDownList'), _dec73 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec74 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec71(_class48 = _dec72(_class48 = _dec73(_class48 = (_class49 = function () {
    ...
    return DropDownList;
  }(), (_descriptor15 = _applyDecoratedDescriptor(_class49.prototype, 'kNoValueBinding', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: function initializer() {
      return false;
    }
  }), _descriptor16 = _applyDecoratedDescriptor(_class49.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor17 = _applyDecoratedDescriptor(_class49.prototype, 'kReadOnly', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  ...
  var Editor = exports.Editor = (_dec75 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'rich-editor'), _dec76 = generateBindables('kendoEditor'), _dec77 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec75(_class51 = _dec76(_class51 = _dec77(_class51 = function () {
  ...
  var FlatColorPicker = exports.FlatColorPicker = (_dec78 = (0, _aureliaTemplating.customElement)(constants.attributePrefix + 'flat-color-picker'), _dec79 = generateBindables('kendoFlatColorPicker'), _dec80 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec78(_class52 = _dec79(_class52 = _dec80(_class52 = function () {
  ...
  var GanttCol = exports.GanttCol = (_dec81 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'gantt-col'), _dec82 = generateBindables('GanttColumn'), _dec83 = (0, _aureliaDependencyInjection.inject)(TemplateGatherer), _dec81(_class53 = _dec82(_class53 = _dec83(_class53 = function GanttCol() {
    
  }) || _class53) || _class53) || _class53);
  var Gantt = exports.Gantt = (_dec84 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'gantt'), _dec85 = generateBindables('kendoGantt'), _dec86 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources, OptionsBuilder), _dec87 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'gantt-col'), _dec88 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec84(_class54 = _dec85(_class54 = _dec86(_class54 = (_class55 = function () {
  ...
  var LinearGauge = exports.LinearGauge = (_dec89 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'linear-gauge'), _dec90 = generateBindables('kendoLinearGauge'), _dec91 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec89(_class57 = _dec90(_class57 = _dec91(_class57 = function () {
  ...
  var RadialGauge = exports.RadialGauge = (_dec92 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'radial-gauge'), _dec93 = generateBindables('kendoRadialGauge'), _dec94 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec92(_class58 = _dec93(_class58 = _dec94(_class58 = function () {
  ...
  var Col = exports.Col = (_dec95 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'col'), _dec96 = generateBindables('GridColumn'), _dec97 = (0, _aureliaDependencyInjection.inject)(TemplateGatherer, OptionsBuilder), _dec98 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec99 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'col'), _dec95(_class59 = _dec96(_class59 = _dec97(_class59 = (_class60 = function () {
  ...
  var GridToolbar = exports.GridToolbar = (_dec100 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'grid-toolbar'), _dec101 = generateBindables('GridToolbarItem'), _dec102 = (0, _aureliaDependencyInjection.inject)(TemplateGatherer), _dec103 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec100(_class62 = _dec101(_class62 = _dec102(_class62 = (_class63 = function () {
  ...
  var Grid = exports.Grid = (_dec104 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'grid'), _dec105 = generateBindables('kendoGrid'), _dec106 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources, OptionsBuilder, TemplateGatherer), _dec107 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'col'), _dec108 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec109 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'grid-toolbar'), _dec104(_class65 = _dec105(_class65 = _dec106(_class65 = (_class66 = function () {
  ...
  var ListView = exports.ListView = (_dec110 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'list-view'), _dec111 = generateBindables('kendoListView'), _dec112 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec113 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec110(_class68 = _dec111(_class68 = _dec112(_class68 = (_class69 = function () {
  ...
  var Map = exports.Map = (_dec114 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'map'), _dec115 = generateBindables('kendoMap'), _dec116 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec114(_class71 = _dec115(_class71 = _dec116(_class71 = function () {
  ...
  var MaskedTextBox = exports.MaskedTextBox = (_dec117 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'maskedtextbox'), _dec118 = generateBindables('kendoMaskedTextBox'), _dec119 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec117(_class72 = _dec118(_class72 = _dec119(_class72 = (_class73 = function () {
  ...
  }(), (_descriptor28 = _applyDecoratedDescriptor(_class73.prototype, 'kDisableDates', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor29 = _applyDecoratedDescriptor(_class73.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor30 = _applyDecoratedDescriptor(_class73.prototype, 'kReadOnly', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class73)) || _class72) || _class72) || _class72);
  var Menu = exports.Menu = (_dec120 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'menu'), _dec121 = generateBindables('kendoMenu'), _dec122 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec120(_class75 = _dec121(_class75 = _dec122(_class75 = function () {
  ...
  var Multiselect = exports.Multiselect = (_dec123 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'multiselect'), _dec124 = generateBindables('kendoMultiSelect', ['template']), _dec125 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec126 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec123(_class76 = _dec124(_class76 = _dec125(_class76 = (_class77 = function () {
    ...
    return Multiselect;
  }(), (_descriptor31 = _applyDecoratedDescriptor(_class77.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor32 = _applyDecoratedDescriptor(_class77.prototype, 'kReadOnly', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor33 = _applyDecoratedDescriptor(_class77.prototype, 'kNoValueBinding', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: function initializer() {
      return false;
    }
  ...
  var NotificationTemplate = exports.NotificationTemplate = (_dec127 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'notification-template'), _dec128 = (0, _aureliaTemplating.noView)(), _dec129 = (0, _aureliaTemplating.processContent)(function (compiler, resources, element, instruction) {
    var html = element.innerHTML;
    if (html !== '') {
      instruction.template = html;
    }
    return true;
  }), _dec130 = (0, _aureliaDependencyInjection.inject)(_aureliaTemplating.TargetInstruction), _dec127(_class79 = _dec128(_class79 = _dec129(_class79 = _dec130(_class79 = (_class80 = function NotificationTemplate(targetInstruction) {
    ...
    this.template = targetInstruction.elementInstruction.template;
  }, (_descriptor35 = _applyDecoratedDescriptor(_class80.prototype, 'template', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor36 = _applyDecoratedDescriptor(_class80.prototype, 'type', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class80)) || _class79) || _class79) || _class79) || _class79);
  var Notification = exports.Notification = (_dec131 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'notification'), _dec132 = generateBindables('kendoNotification'), _dec133 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec134 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'notification-template'), _dec131(_class82 = _dec132(_class82 = _dec133(_class82 = (_class83 = function () {
  ...
  var NumericTextBox = exports.NumericTextBox = (_dec135 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'numerictextbox'), _dec136 = generateBindables('kendoNumericTextBox'), _dec137 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec135(_class85 = _dec136(_class85 = _dec137(_class85 = (_class86 = function () {
  ...
  }(), (_descriptor38 = _applyDecoratedDescriptor(_class86.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor39 = _applyDecoratedDescriptor(_class86.prototype, 'kReadOnly', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class86)) || _class85) || _class85) || _class85);
  var PanelBar = exports.PanelBar = (_dec138 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'panel-bar'), _dec139 = generateBindables('kendoPanelBar'), _dec140 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec138(_class88 = _dec139(_class88 = _dec140(_class88 = function () {
  ...
  var PivotConfigurator = exports.PivotConfigurator = (_dec141 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'pivot-configurator'), _dec142 = generateBindables('kendoPivotConfigurator'), _dec143 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec141(_class89 = _dec142(_class89 = _dec143(_class89 = function () {
  ...
  var PivotGrid = exports.PivotGrid = (_dec144 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'pivot-grid'), _dec145 = generateBindables('kendoPivotGrid'), _dec146 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec147 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec144(_class90 = _dec145(_class90 = _dec146(_class90 = (_class91 = function () {
  ...
  var ProgressBar = exports.ProgressBar = (_dec148 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'progress-bar'), _dec149 = generateBindables('kendoProgressBar'), _dec150 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec148(_class93 = _dec149(_class93 = _dec150(_class93 = (_class94 = function () {
    ...
    return ProgressBar;
  }(), (_descriptor41 = _applyDecoratedDescriptor(_class94.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class94)) || _class93) || _class93) || _class93);
  var QRCode = exports.QRCode = (_dec151 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'qrcode'), _dec152 = generateBindables('kendoQRCode'), _dec153 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec151(_class96 = _dec152(_class96 = _dec153(_class96 = function () {
  ...
  var RangeSlider = exports.RangeSlider = (_dec154 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'range-slider'), _dec155 = generateBindables('kendoRangeSlider'), _dec156 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec154(_class97 = _dec155(_class97 = _dec156(_class97 = (_class98 = function () {
    ...
    return RangeSlider;
  }(), (_descriptor42 = _applyDecoratedDescriptor(_class98.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class98)) || _class97) || _class97) || _class97);
  var ResponsivePanel = exports.ResponsivePanel = (_dec157 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'responsivepanel'), _dec158 = generateBindables('kendoResponsivePanel'), _dec159 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec157(_class100 = _dec158(_class100 = _dec159(_class100 = function () {
  ...
  var Scheduler = exports.Scheduler = (_dec160 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'scheduler'), _dec161 = generateBindables('kendoScheduler'), _dec162 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec163 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec160(_class101 = _dec161(_class101 = _dec162(_class101 = (_class102 = function () {
  ...
  var Scrollview = exports.Scrollview = (_dec164 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'scrollview'), _dec165 = generateBindables('kendoMobileScrollView'), _dec166 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec167 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec164(_class104 = _dec165(_class104 = _dec166(_class104 = (_class105 = function () {
  ...
  var Slider = exports.Slider = (_dec168 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'slider'), _dec169 = generateBindables('kendoSlider'), _dec170 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec168(_class107 = _dec169(_class107 = _dec170(_class107 = (_class108 = function () {
    ...
    return Slider;
  }(), (_descriptor45 = _applyDecoratedDescriptor(_class108.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class108)) || _class107) || _class107) || _class107);
  var Sortable = exports.Sortable = (_dec171 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'sortable'), _dec172 = generateBindables('kendoSortable'), _dec173 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec171(_class110 = _dec172(_class110 = _dec173(_class110 = function () {
  ...
  var Splitter = exports.Splitter = (_dec174 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'splitter'), _dec175 = generateBindables('kendoSplitter'), _dec176 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec174(_class111 = _dec175(_class111 = _dec176(_class111 = function () {
  ...
  var Spreadsheet = exports.Spreadsheet = (_dec177 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'spreadsheet'), _dec178 = generateBindables('kendoSpreadsheet'), _dec179 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec177(_class112 = _dec178(_class112 = _dec179(_class112 = function () {
  ...
  var Switch = exports.Switch = (_dec180 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'switch'), _dec181 = generateBindables('kendoMobileSwitch'), _dec182 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec180(_class113 = _dec181(_class113 = _dec182(_class113 = (_class114 = function () {
    ...
    return Switch;
  }(), (_descriptor46 = _applyDecoratedDescriptor(_class114.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class114)) || _class113) || _class113) || _class113);
  var TabStrip = exports.TabStrip = (_dec183 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'tabstrip'), _dec184 = generateBindables('kendoTabStrip'), _dec185 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec183(_class116 = _dec184(_class116 = _dec185(_class116 = function () {
  ...
  var TimePicker = exports.TimePicker = (_dec186 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'timepicker'), _dec187 = generateBindables('kendoTimePicker'), _dec188 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec186(_class117 = _dec187(_class117 = _dec188(_class117 = (_class118 = function () {
    ...
    return TimePicker;
  }(), (_descriptor47 = _applyDecoratedDescriptor(_class118.prototype, 'kDisableDates', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor48 = _applyDecoratedDescriptor(_class118.prototype, 'kEnabled', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor49 = _applyDecoratedDescriptor(_class118.prototype, 'kReadOnly', [_aureliaTemplating.bindable], {
    enumerable: true,
    initializer: null
  })), _class118)) || _class117) || _class117) || _class117);
  var ToolbarItemButton = exports.ToolbarItemButton = (_dec189 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'toolbar-item-button'), _dec190 = generateBindables('ToolBarItemButton'), _dec191 = (0, _aureliaDependencyInjection.inject)(OptionsBuilder), _dec189(_class120 = _dec190(_class120 = _dec191(_class120 = function () {
  ...
  var ToolbarItem = exports.ToolbarItem = (_dec192 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'toolbar-item'), _dec193 = generateBindables('ToolBarItem'), _dec194 = (0, _aureliaDependencyInjection.inject)(TemplateGatherer, OptionsBuilder), _dec195 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec196 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'toolbar-item-button'), _dec192(_class121 = _dec193(_class121 = _dec194(_class121 = (_class122 = function () {
  ...
  var Toolbar = exports.Toolbar = (_dec197 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'toolbar'), _dec198 = generateBindables('kendoToolBar'), _dec199 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, OptionsBuilder), _dec200 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'toolbar-item'), _dec197(_class124 = _dec198(_class124 = _dec199(_class124 = (_class125 = function () {
  ...
  var Tooltip = exports.Tooltip = (_dec201 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'tooltip'), _dec202 = generateBindables('kendoTooltip'), _dec203 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec201(_class127 = _dec202(_class127 = _dec203(_class127 = function () {
  ...
  var TreeCol = exports.TreeCol = (_dec204 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'tree-col'), _dec205 = generateBindables('TreeListColumn'), _dec206 = (0, _aureliaDependencyInjection.inject)(TemplateGatherer), _dec207 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec204(_class128 = _dec205(_class128 = _dec206(_class128 = (_class129 = function () {
  ...
  var TreeList = exports.TreeList = (_dec208 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'tree-list'), _dec209 = generateBindables('kendoTreeList'), _dec210 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources, OptionsBuilder), _dec211 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'tree-col'), _dec208(_class131 = _dec209(_class131 = _dec210(_class131 = (_class132 = function () {
  ...
  var TreeView = exports.TreeView = (_dec212 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'treeview'), _dec213 = generateBindables('kendoTreeView'), _dec214 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec212(_class134 = _dec213(_class134 = _dec214(_class134 = function () {
  ...
  var Upload = exports.Upload = (_dec215 = (0, _aureliaTemplating.customElement)(constants.elementPrefix + 'upload'), _dec216 = generateBindables('kendoUpload'), _dec217 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase, _aureliaTemplating.ViewResources), _dec218 = (0, _aureliaTemplating.children)(constants.elementPrefix + 'template'), _dec215(_class135 = _dec216(_class135 = _dec217(_class135 = (_class136 = function () {
  ...
  var Validator = exports.Validator = (_dec219 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'validator'), _dec220 = generateBindables('kendoValidator'), _dec221 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec219(_class138 = _dec220(_class138 = _dec221(_class138 = function () {
  ...
  var Window = exports.Window = (_dec222 = (0, _aureliaTemplating.customAttribute)(constants.attributePrefix + 'window'), _dec223 = generateBindables('kendoWindow'), _dec224 = (0, _aureliaDependencyInjection.inject)(Element, WidgetBase), _dec222(_class139 = _dec223(_class139 = _dec224(_class139 = function () {
