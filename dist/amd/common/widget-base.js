define(['exports', './options', './events', './util', 'aurelia-framework', 'aurelia-dependency-injection'], function (exports, _options, _events, _util, _aureliaFramework, _aureliaDependencyInjection) {
  'use strict';
