define(['exports', 'aurelia-framework', '../common/index', 'jquery', 'kendo-ui/js/kendo.menu.min'], function (exports, _aureliaFramework, _commonIndex, _jquery, _kendoUiJsKendoMenuMin) {
  'use strict';
