define(['exports', 'jquery', 'kendo-ui/js/kendo.autocomplete.min', 'kendo-ui/js/kendo.button.min', 'kendo-ui/js/kendo.grid.min', 'kendo-ui/js/kendo.tabstrip.min', 'aurelia-framework', 'aurelia-logging'], function (exports, _jquery, _kendoUiJsKendoAutocompleteMin, _kendoUiJsKendoButtonMin, _kendoUiJsKendoGridMin, _kendoUiJsKendoTabstripMin, _aureliaFramework, _aureliaLogging) {
    'use strict';
    ...
    var AuKendoAutoComplete = (function () {
        ...
        AuKendoAutoComplete.prototype.attached = function attached() {
            ...
            this._component = _$['default'](this.element).kendoAutoComplete(this.getOptions()).data("kendoAutoComplete");
    ...
    var AuKendoButton = (function () {
        ...
        AuKendoButton.prototype.attached = function attached() {
            this._component = _$['default'](this.element).kendoButton(this.getOptions()).data('kendoButton');
        };
    ...
    var Grid = (function () {
        ...
        Grid.prototype.attached = function attached() {
            this._component = _$['default'](this.host).kendoGrid(this.getOptions()).data("kendoGrid");
        };
    ...
    var TabStrip = (function () {
        ...
        TabStrip.prototype.attached = function attached() {
            this._component = _$['default'](this.element).kendoTabStrip(this.getOptions()).data('kendoTabStrip');
        };
