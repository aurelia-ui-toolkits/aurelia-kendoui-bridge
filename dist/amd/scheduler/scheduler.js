define(['exports', 'aurelia-framework', '../common/options', 'jquery', 'kendo-ui/js/kendo.scheduler.min'], function (exports, _aureliaFramework, _commonOptions, _jquery, _kendoUiJsKendoSchedulerMin) {
  'use strict';
