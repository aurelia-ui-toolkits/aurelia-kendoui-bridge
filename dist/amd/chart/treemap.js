define(['exports', 'aurelia-framework', '../common/index', 'jquery', 'kendo-ui/js/kendo.dataviz.treemap.min'], function (exports, _aureliaFramework, _commonIndex, _jquery, _kendoUiJsKendoDatavizTreemapMin) {
  'use strict';
