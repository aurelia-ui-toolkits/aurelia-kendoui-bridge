define(['exports', 'aurelia-framework', 'aurelia-logging', '../common/options', 'jquery', 'kendo-ui/js/kendo.grid.min'], function (exports, _aureliaFramework, _aureliaLogging, _commonOptions, _jquery, _kendoUiJsKendoGridMin) {
  'use strict';
