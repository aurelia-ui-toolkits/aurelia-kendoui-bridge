define(['exports', 'aurelia-framework', '../common/options', 'jquery', 'kendo-ui/js/kendo.tabstrip.min'], function (exports, _aureliaFramework, _commonOptions, _jquery, _kendoUiJsKendoTabstripMin) {
    'use strict';
