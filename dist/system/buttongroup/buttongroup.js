System.register(['aurelia-dependency-injection', 'aurelia-templating', '../common/widget-base', '../common/decorators', '../common/constants', 'kendo.mobile.buttongroup.min'], function (_export) {
  'use strict';

  var inject, customAttribute, bindable, WidgetBase, generateBindables, constants, ButtonGroup;
  ...
  return {
    ...
    }, function (_kendoMobileButtongroupMin) {}],
    execute: function () {
      ButtonGroup = (function () {
        ...
        ButtonGroup = inject(Element, WidgetBase)(ButtonGroup) || ButtonGroup;
        ButtonGroup = generateBindables('kendoMobileButtonGroup')(ButtonGroup) || ButtonGroup;
        ButtonGroup = customAttribute(constants.attributePrefix + 'buttongroup')(ButtonGroup) || ButtonGroup;
        return ButtonGroup;
      })();
