System.register(['./bindables', 'aurelia-dependency-injection', './util'], function (_export) {
  'use strict';

  var bindables, inject, Util, ControlProperties;
  ...
  return {
    ...
    execute: function () {
      ControlProperties = (function () {
        ...
        ControlProperties = inject(Util)(ControlProperties) || ControlProperties;
