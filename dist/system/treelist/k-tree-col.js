System.register(['aurelia-dependency-injection', 'aurelia-templating', '../common/constants'], function (_export) {
  ...
  var inject, customElement, bindable, noView, processContent, TargetInstruction, constants, TreeCol;
  ...
  return {
    ...
    execute: function () {
      TreeCol = (function () {
        ...
        TreeCol = inject(TargetInstruction)(TreeCol) || TreeCol;
        TreeCol = processContent(function (compiler, resources, element, instruction) {
        ...
        TreeCol = noView(TreeCol) || TreeCol;
        return TreeCol;
      })();
