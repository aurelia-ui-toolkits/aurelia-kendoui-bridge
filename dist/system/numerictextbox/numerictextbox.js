System.register(['aurelia-framework', '../common/widget-base', '../common/decorators', 'kendo-ui/js/kendo.numerictextbox.min'], function (_export) {
  'use strict';

  var customAttribute, bindable, inject, WidgetBase, generateBindables, NumericTextBox;
  ...
  return {
    ...
    execute: function () {
      NumericTextBox = (function (_WidgetBase) {
        ...
        NumericTextBox = inject(Element)(NumericTextBox) || NumericTextBox;
