...
System.register(['aurelia-dependency-injection', 'aurelia-templating', '../common/widget-base', '../common/decorators', '../common/constants', 'kendo.numerictextbox.min'], function (_export, _context) {
  "use strict";

  var inject, customAttribute, bindable, WidgetBase, generateBindables, constants, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, _descriptor2, NumericTextBox;
  ...
  return {
    ...
    }, function (_kendoNumerictextboxMin) {}],
    execute: function () {
      _export('NumericTextBox', NumericTextBox = (_dec = customAttribute(constants.attributePrefix + 'numerictextbox'), _dec2 = generateBindables('kendoNumericTextBox'), _dec3 = inject(Element, WidgetBase), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = function () {
