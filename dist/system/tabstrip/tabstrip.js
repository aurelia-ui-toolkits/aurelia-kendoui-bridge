System.register(['aurelia-dependency-injection', 'aurelia-templating', '../common/widget-base', '../common/decorators', 'kendo-ui/js/kendo.tabstrip.min'], function (_export) {
  'use strict';

  var inject, customAttribute, bindable, WidgetBase, generateBindables, TabStrip;
  ...
  return {
    ...
    execute: function () {
      TabStrip = (function () {
        ...
        TabStrip = customAttribute('k-tabstrip')(TabStrip) || TabStrip;
        return TabStrip;
      })();
