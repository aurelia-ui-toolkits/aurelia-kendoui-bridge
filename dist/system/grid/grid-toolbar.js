System.register(['aurelia-templating', 'aurelia-dependency-injection', '../common/constants', '../common/decorators', '../common/template-gatherer'], function (_export) {
  ...
  var children, customElement, inject, constants, generateBindables, TemplateGatherer, GridToolbar;
  ...
  return {
    ...
    execute: function () {
      GridToolbar = (function () {
        ...
        GridToolbar = inject(TemplateGatherer)(GridToolbar) || GridToolbar;
        GridToolbar = generateBindables('GridToolbarItem')(GridToolbar) || GridToolbar;
        GridToolbar = customElement(constants.elementPrefix + 'grid-toolbar')(GridToolbar) || GridToolbar;
        return GridToolbar;
      })();
