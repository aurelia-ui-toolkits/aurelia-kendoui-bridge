System.register(['aurelia-dependency-injection', 'aurelia-templating', '../common/widget-base', '../common/decorators', '../common/constants'], function (_export, _context) {
  ...
  var inject, Container, customElement, bindable, WidgetBase, generateBindables, constants, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, DropDownTree;
  ...
  return {
    ...
    execute: function () {
      _export('DropDownTree', DropDownTree = (_dec = customElement(constants.elementPrefix + 'drop-down-tree'), _dec2 = generateBindables('kendoDropDownTree'), _dec3 = inject(Element, WidgetBase, Container), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = function () {
      ...
      _export('DropDownTree', DropDownTree);
    }
  };
});
//# sourceMappingURL=../dist/dev/dropdowntree/dropdowntree.js.map
